...
#most popular start stations  and plot
```{r}
library(readr)
library(dplyr)
...
citibike$speed <- citibike$distance / citibike$tripduration
citibike$speed
...
#create a new data frame with the top 5
top_5start <- head(top_5start, 5)
top_5start

#plot on leaflet

#different amount of observations for stations and start station names (can look into)
